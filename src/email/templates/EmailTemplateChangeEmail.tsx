...
export const EmailTemplateChangeEmail = ({
  inviteLink,
}: EmailTemplateProps) => {
  const previewText = `Confirm your new email address`;
        ...
        <Body className="mx-auto my-auto bg-white px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[465px] rounded border border-solid border-[#eaeaea] p-[20px]">
            <Heading className="mx-0 my-[30px] p-0 text-center text-[24px] font-normal text-black">
              <strong>Confirm Your New Email Address</strong>
            </Heading>
            ...
            <Text className="text-[12px] leading-[24px] text-[#666666]">
              ...
              email. Your email address will not be updated.
            </Text>
          </Container>
        </Body>
      </Tailwind>
...
EmailTemplateChangeEmail.PreviewProps = {
  inviteLink: "http://localhost:3000",
};

export default EmailTemplateChangeEmail;
